...
private:
    ...
    public:
        ...
        nav_msgs::Odometry control_odom;
    ...
    public:
        ...
        msr::airlib::MultirotorState truth_state;
    ...
    nav_msgs::Odometry get_odom_msg_from_truth_state(const msr::airlib::MultirotorState& truth_state) const;
...
private:
    ...
    // const std::string AIRSIM_FRAME_ID = "world_enu";
